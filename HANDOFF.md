...
1. Go to `/admin` on the site and click **Login** (signs in with your GitHub
   account, and you must be a member of the Sovrin-Group GitHub organization)
...
| Website files + history | GitHub org `Sovrin-Group` | Organization **owners** (multiple people, and any owner has full control) |
